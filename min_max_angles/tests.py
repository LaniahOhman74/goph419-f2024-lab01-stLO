...
'''
Tests that run through failed and passed scenarios for the definitions
Prints the expected outcome in relation to failed tests
'''

#Failed test 
def sinversetest():
    #Will not pass, raises a value error
    x = 2.0
    print(f"{x} = {arcsin(x)}")
